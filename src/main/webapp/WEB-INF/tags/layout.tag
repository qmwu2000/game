...
<jsp:useBean id="navBar" class="org.unidal.game.hanjiangsanguo.view.NavigationBar" scope="page" />

<!DOCTYPE html>
<html lang="en">

<head>
	<title>Hanjiang - ${model.page.description}</title>
	<meta http-equiv="content-type" content="text/html; charset=UTF-8" />
	<meta name="viewport" content="width=device-width, initial-scale=1.0">
	<meta name="description" content="Hanjiang">
...
<body data-spy="scroll" data-target=".subnav" data-offset="50">
	...
	<div class="container-fluid" style="min-height:524px;">
		...
		<br />
		<div class="container">
			<footer><center>&copy;2013 Dianping Hanjiang Team</center></footer>
		</div>
	</div>
	<!--/.fluid-container-->
